            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                    ...
                    <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                        ...
                        <li class="text-slate-700 dark:text-zink-100">Add New</li>
                    </ul>
                </div>
                    ...
                    <div class="xl:col-span-4">
                        ...
                        <div class="card sticky top-[calc(theme('spacing.header')_*_1.3)]">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <h5 class="mb-2">$<span id="preview-price">0.00</span></h5>
                                    <h6 class="mb-1 text-15" id="preview-name">Product Name</h6>
                                    <p class="text-slate-500 dark:text-zink-200" id="preview-category">Category</p>
                                    <p class="text-slate-500 dark:text-zink-200">Stock: <span id="preview-stock">0</span></p>
                                    <p class="text-slate-500 dark:text-zink-200">SKU: <span id="preview-sku">Auto-generated</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <li class="hidden" id="dropzone-preview-list">
                                                    <div class="border rounded border-slate-200 dark:border-zink-500 overflow-hidden">
                                                        <div class="p-2 text-center">
                                                            ...
                                                            <div class="pt-3">
                                                                <h5 class="mb-1 text-15 truncate" data-dz-name>&nbsp;</h5>
                                                                <p class="mb-0 text-xs text-slate-500 dark:text-zink-200" data-dz-size></p>
                                        ...
                                        <div class="lg:col-span-2 xl:col-span-6">
                                            <div>
                                                ...
                                                <textarea id="description_ar" name="description_ar" rows="5"
                                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                    placeholder="Enter Description in Arabic" dir="rtl">{{ old('description_ar') }}</textarea>
            ...
            document.getElementById('productForm').addEventListener('submit', function(e) {
                ...
                if (files.length > 0) {
                    files.forEach(function(file, index) {
                        // Make sure we're only adding actual File objects
