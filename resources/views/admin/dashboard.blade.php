                        ...
                        <div class="flex flex-col gap-4 mb-4 md:mb-3 md:items-center md:flex-row">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" class="ltr:pl-10 rtl:pr-10 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                       data-provider="flatpickr" data-date-format="d M, Y" data-range-date="true" readonly="readonly" placeholder="Select Date">
                            </div>
                        </div>
                            ...
                            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        ...
                                        <h5 class="text-15">
                                            $<span class="counter-value" data-target="{{ number_format(array_sum($dashboardData['monthly_sales']['sales']) / 1000, 2) }}">0</span>k
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        ...
                                        <h5 class="text-15">
                                            $<span class="counter-value" data-target="{{ number_format(array_sum($dashboardData['monthly_sales']['profits']) / 1000, 2) }}">0</span>k
                                        </h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="salesRevenueOverview" class="apex-charts" data-chart-colors='["bg-custom-500", "bg-custom-400"]' dir="ltr"
                             data-months='@json($dashboardData['monthly_sales']['months'])'
                             data-sales='@json($dashboardData['monthly_sales']['sales'])'
                             data-profits='@json($dashboardData['monthly_sales']['profits'])'>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex items-center gap-3 my-3">
                            ...
                            <div class="grow">
                                <p class="mb-1 text-slate-500 dark:text-zink-200">Total Profit</p>
                                <h5 class="text-15">
                                    $<span class="counter-value" data-target="{{ number_format(end($dashboardData['monthly_sales']['profits']) / 1000, 2) }}">0</span>k
                                </h5>
                            </div>
                        </div>
                        <div id="salesThisMonthChart" class="apex-charts"
                             data-chart-colors='["bg-sky-500", "bg-orange-500"]' dir="ltr"
                             data-months='@json($dashboardData['monthly_sales']['months'])'
                             data-sales='@json($dashboardData['monthly_sales']['sales'])'>
                        </div>
                    </div>
