                        ...
                        <ul class="flex flex-col gap-5">
                            <li class="flex items-center gap-3">
                                <div
                                    ...
                                    <img src="{{ asset('admin/assets/images/img-02.png') }}" alt=""
                                        class="h-6">
                                </div>
                            ...
                            <li class="flex items-center gap-3">
                                <div
                                    class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ asset('admin/assets/images/img-03.png') }}" alt=""
                                        class="h-6">
                                </div>
                                <div class="overflow-hidden grow">
                            ...
                            <li class="flex items-center gap-3">
                                <div
                                    class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ asset('admin/assets/images/img-04.png') }}" alt=""
                                        class="h-6">
                                </div>
                                <div class="overflow-hidden grow">
                            ...
                            <li class="flex items-center gap-3">
                                <div
                                    class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ asset('admin/assets/images/img-05.png') }}" alt=""
                                        class="h-6">
                                </div>
                                <div class="overflow-hidden grow">
                            ...
                            <li class="flex items-center gap-3">
                                <div
                                    class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ asset('admin/assets/images/img-06.png') }}" alt=""
                                        class="h-6">
                                </div>
                                <div class="overflow-hidden grow">
